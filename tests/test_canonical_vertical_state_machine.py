...
class CanonicalVerticalStateMachineTests(unittest.TestCase):
    def build_machine(self):
        ...
        # This synthetic graph has P=2. Build a minimal phase/merge spec through
        # the generic lift rather than relying on the topological P=3 formula:
        # the implementation itself uses partition_machine.field.period.
    ...
    def test_stepwise_rewind_returns_exact_prefix_state(self):
        machine = self.build_machine()
